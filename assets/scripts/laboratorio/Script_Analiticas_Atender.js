$(document).ready(() => {
   $("#buscar").click(() => {
      ...
      $.post(localStorage.getItem("hc_base_url") + "Laboratorio_controller/buscarAnalitica", {id:codigo}, (data) => {
         ...
         if(data.length == 0) {
            ...
            Swal.fire({
               ...
               $.post(localStorage.getItem("hc_base_url") + "Laboratorio_controller/atenderAnalitica", {id: codigo}, (respuesta) => {
                  if(respuesta == 1) {
                     Swal.fire({
                        icon: 'success',
                        title: 'Hecho',
